...
export default function StaffPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-background">
      {/* HERO */}
      <section className="relative pt-12 pb-20 px-6 md:px-12 text-center bg-gradient-to-br from-brand-primary/30 via-brand-primary/10 to-brand-background overflow-hidden">
