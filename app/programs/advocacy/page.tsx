...
export default function AdvocacyPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 pt-32 bg-gradient-to-br from-indigo-50 to-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* <Image src="/images/advocacy-hero.jpg" alt="Advocacy Session" fill className="object-cover" priority /> */}
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link 
                  href="/contact"
                  className="inline-flex items-center bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg"
                >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-12">
            {/* Event 1 */}
            <div className="bg-gradient-to-r from-indigo-50 to-white rounded-2xl p-8 border border-indigo-100">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-2">
                  <span className="text-indigo-600 font-bold text-sm uppercase tracking-wide">March 2023</span>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-center">
                    <span className="text-4xl font-black text-indigo-600 block">150+</span>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-white rounded-2xl p-8 border border-purple-100">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-2">
                  <span className="text-purple-600 font-bold text-sm uppercase tracking-wide">September 2023</span>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-center">
                    <span className="text-4xl font-black text-purple-600 block">200+</span>
                    <span className="text-gray-500 text-sm">Participants</span>
                  </div>
                  <div className="mt-4 pt-4 border-t text-center">
            ...
            {/* Event 3 */}
            <div className="bg-gradient-to-r from-orange-50 to-white rounded-2xl p-8 border border-orange-100">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-2">
                  <span className="text-orange-600 font-bold text-sm uppercase tracking-wide">Ongoing Initiative</span>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-center">
                    <span className="text-4xl font-black text-orange-600 block">75+</span>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <div className="flex justify-center items-center gap-8 md:gap-16">
            ...
            >
              ...
              <span className="mt-4 font-bold text-gray-700 group-hover:text-blue-600 transition">Facebook</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link href="/esl" className="group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-indigo-600 transition">ESL Program</h3>
            ...
            <Link href="/health" className="group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-indigo-600 transition">Health Program</h3>
                <p className="text-gray-600 mb-4">
