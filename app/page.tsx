...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-brand-background">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={idx} className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 py-6 group hover:bg-white/50 rounded-xl transition-colors px-4 -mx-4">
              ...
              <div className="md:w-3/4 w-full flex items-start gap-3">
                <span className="text-brand-primary text-xl md:text-2xl mt-1 flex-shrink-0">:</span>
      ...
      <section className="py-16 px-6 md:px-12 max-w-7xl mx-auto border-t border-gray-200">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-80 md:h-96 rounded-2xl overflow-hidden shadow-xl">
            <Image 
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-black text-black mb-6">How We Fulfill Our Mission</h2>
            <ul className="space-y-3 text-base md:text-lg text-gray-700">
              <li className="flex items-start gap-3">
                <span className="text-brand-primary font-black text-lg mt-0.5">•</span>
